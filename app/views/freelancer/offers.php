        ...
        <div class="container mx-auto max-w-6xl">
            ...
            <?php if (empty($offers)): ?>
                <div class="bg-white rounded-lg shadow-md p-6 text-center text-gray-500">
                    ...
                    <a href="/freelancer/projects" class="text-blue-600 hover:text-blue-700 ml-1">Browse available projects</a>
                </div>
            <?php else: ?>
                        ...
                        <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-4">
                            ...
                            <div class="text-xs text-gray-500 space-y-1 mb-3">
                                <div class="flex items-center">
                                    ...
                                    <?= htmlspecialchars($offer['client_name']) ?>
                                </div>
                                <div class="flex items-center">
                            ...
                            <div class="flex justify-end space-x-2">
                                <?php if ($offer['status'] === 'pending'): ?>
                                    <a href="/freelancer/offers/<?= $offer['id_offer'] ?>/edit" 
                                ...
                                <?php endif; ?>
                                <form method="POST" action="/freelancer/offers/<?= $offer['id_offer'] ?>/delete" class="inline" 
